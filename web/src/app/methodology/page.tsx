      ...
      <div className="mx-auto max-w-2xl px-4 pt-6">
        ...
        <section className="mt-5 rounded-2xl bg-zinc-900/70 p-5 ring-1 ring-zinc-800">
          ...
          <ul className="mt-3 space-y-1.5 text-sm text-zinc-300">
            ...
            <li><span className="text-amber-300 font-medium">Trim</span>: a <i>confluence</i> of ≥2 distinct deterioration signals, <i>at least one of them hard</i>. Hard: confirmed downtrend, revenue weakening, a severe margin collapse (≥5pp). Soft: an underperforming relative-strength regime, a mild margin dip, deteriorating earnings quality (negative EPS growth / repeated misses). Soft signals alone get a &quot;Review&quot; badge — never an auto-trim. Keeps at least the $200 floor.</li>
